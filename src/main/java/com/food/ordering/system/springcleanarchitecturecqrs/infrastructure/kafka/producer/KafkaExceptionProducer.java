...
@Slf4j
@Component
public class KafkaExceptionProducer {

    private final ObjectMapper objectMapper;
    private final KafkaConfig kafkaConfig;
    private final KafkaTemplate<String, String> kafkaTemplate;

    public KafkaExceptionProducer(ObjectMapper objectMapper, KafkaConfig kafkaConfig, KafkaTemplate<String, String> kafkaTemplate) {
    ...
    public void sendException(KafkaException exception) {
        try {
            ...
            kafkaTemplate.send(kafkaConfig.getKafkaProducerExceptionTopic(), exceptionMessage);
